...
{ 
    ...
    [ApiController]
    public partial class GroupCategoryController: ControllerBase
    {
        protected readonly ILogger<GroupCategoryController> logger;
        protected readonly IGroupCategoryService service;

        public GroupCategoryController(ILogger<GroupCategoryController> logger, IGroupCategoryService service)
        {
            this.logger = logger;
        ...
        public async Task<IActionResult> Get([FromQuery] Dictionary<string, string> filters)
        {
            ...
            var modelType = typeof(GroupCategory);
        ...
        {
            var item = JsonConvert.DeserializeObject<GroupCategory>(value.ToString());
